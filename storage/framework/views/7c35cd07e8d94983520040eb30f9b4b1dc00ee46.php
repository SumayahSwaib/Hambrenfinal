...
<header class="main-header">
    ...
    <a href="<?php echo e(admin_url('/'), false); ?>" class="logo">
        ...
        <span class="logo-mini"><?php echo 'Invoice Ninja'; ?></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><?php echo 'Invoice Ninja'; ?></span>
    </a>
...
<?php /**PATH C:\github\InvoiceNinja\vendor\encore\laravel-admin\src/../resources/views/partials/header.blade.php ENDPATH**/ ?>