...
<head>
    ...
    <title>Invoice - <?php echo e($c->id, false); ?></title>
    ...
    <table class="w-100 ">
        <tbody>
            ...
            <tr>
                ...
                <td style="width: 15%;">
                    <p>INOVICE NO. <b style="color: red;"><i>0000<?php echo e($c->id, false); ?></i></b></p>
                </td>
            </tr>
        </tbody>
    </table>
...
<?php /**PATH C:\github\InvoiceNinja\resources\views/print/invoice.blade.php ENDPATH**/ ?>