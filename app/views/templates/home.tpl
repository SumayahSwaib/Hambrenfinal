                    ...
                    <div class="explore-product-activation slick-layout-wrapper slick-layout-wrapper--15 axil-slick-arrow arrow-top-slide">
                        <div class="slick-single-layout">
                            <div class="row row--15">
                                ...
                                <div class="col-xl-2 col-lg-3 col-sm-6 col-12 mb--30">

                                    <div class="axil-product product-style-one">
                                        <div class="thumbnail">
                                            <a href="/product/{$product['url']}">
                                                <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="800" loading="lazy" class="main-img" src="/media/products_thumbnails/{$product['feature_photo']}" alt="Product Images">
                                                <img class="hover-img" src="/media/products_thumbnails/{$product['photo']}" alt="Product Images">
                                            </a>
