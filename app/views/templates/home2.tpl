                        ...
                        {foreach $categories as $item}
                            <div class="slick-single-layout">
                                <div class="categrie-product" data-sal="zoom-out" data-sal-delay="200" data-sal-duration="500">
                                    <a href="/{$item['url']}" style="background: #b0cd6e; color: white">
                                        <img class="img-fluid" src="{if $item['image_origin'] == 1}/assets/images/product/categories/{$item['image']}{else}{$item['image']}{/if}" alt="product categorie">
                                        <h6 class="cat-title">{$item['category']}</h6>
                                    </a>
                                </div>
                                    ...
                                    <div class="axil-product product-style-one shadow-sm">
                                        <div class="thumbnail rounded-0">
                                            <a href="/product/{$product['url']}">
                                                <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="800" loading="lazy" class="main-img" src="/media/products_thumbnails/{$product['feature_photo']}" style="border-radius: 0 0 0 0 !important;" alt="Product Images">
                                                <img class="hover-img" src="/media/products_thumbnails/{$product['photo']}" style="border-radius: 0 0 0 0 !important;" alt="Product Images">
                                            </a>
                        ...
                        <div class="new-arrivals-product-activation slick-layout-wrapper--30 axil-slick-arrow  arrow-top-slide">
                            ...
                            <div class="slick-single-layout">
                                <div class="axil-product product-style-two shadow-sm">
                                    <div class="thumbnail rounded-0">
                                        <a href="/product/{$product['url']}">
                                            <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="500" src="/media/products_thumbnails/{$product['feature_photo']}" alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
